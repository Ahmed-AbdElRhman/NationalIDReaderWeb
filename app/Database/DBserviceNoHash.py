...
from models import AppSubscription, AdminUser
...
class OCRDB:
    def __init__(self, db_path: str = os.environ.get("DB_NAME", "instance/OCRDB.db")):
        ...
        self.max_scans = os.getenv('MAX_SCANS', 30000)  # Default to 1000 scans
    ...
    def get_app_subscription(self) -> Optional[AppSubscription]:
        ...
        print("Getting app subscription...")  # Debugging print statement
        print(self.subscription)  # Debugging print statement
        if self.subscription:
            print(f"Returning cached subscription: {self.subscription}")  # Debugging print statement
    ...
    def save_app_subscription(self, subscription: AppSubscription) -> bool:
        ...
        try:
            ...
            conn.commit()
            logger.info("App subscription Updated successfully")
            self.subscription = subscription  # Cache the updated subscription
            print("HIIIIII")
            print(f"Updated subscription: {self.subscription}")  # Debugging print statement
            return True
        except Exception as e:
            logger.error(f"Error Updated app subscription: {e}")
            return False
    ...
    def createNew_app_subscription(self, install_date: datetime = None) -> Optional[AppSubscription]:
        ...
        try:
            ...
            # Compute verification hash
            subscription.verification_hash = subscription.compute_hash(self.secret_key)
            print(f'first Computed subscription: {subscription}')  # Debugging print statement
            print(self.secret_key)
            print(f"first Computed hash: {subscription.verification_hash}")  # Debugging print statement
    ...
    def verify_subscription(self) -> bool:
        ...
        try:
            ...
            print(f'Current Computed subscription: {subscription}')  # Debugging print statement
            print(f"Current before start new compute Computed hash: {subscription.verification_hash}")  # Debugging print statement
            ...
            print(f"New  compute Computed hash: {computed_hash}")  # Debugging print statement
    ...
    def increment_scan_count(self, validateRequired:bool = True) -> bool:
